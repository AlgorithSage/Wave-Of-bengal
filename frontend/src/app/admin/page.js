    ...
    return (
        <div className="space-y-8 mb-20 md:mb-0">
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-8">
                <header>
                    <h1 className="text-4xl font-heading font-bold text-ocean-deep">Dashboard Overview</h1>
                    <p className="text-ocean-muted mt-2">Welcome back. Here is what is happening today.</p>
                </header>
                <Link
                    href="/home"
                    className="flex items-center gap-2 px-6 py-3 bg-white/60 hover:bg-white/80 border border-white/40 rounded-full font-bold text-ocean-deep shadow-sm transition-all duration-300 hover:-translate-y-1 hover:shadow-md"
                >
