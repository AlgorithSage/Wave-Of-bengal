...
export default function Register() {
    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-[#FAFAFA] relative overflow-hidden p-4">
            ...
            <div className="absolute inset-0 z-0 bg-[radial-gradient(ellipse_at_center,var(--tw-gradient-stops))] from-sky-light/80 via-[#FAFAFA] to-[#FAFAFA]"></div>
                ...
                <motion.div variants={containerVariants} initial="hidden" animate="show">
                    ...
                    <form onSubmit={handleRegister} className="space-y-4">
                        <motion.div variants={itemVariants}>
                            <label className="block text-ocean-deep font-bold text-sm mb-1.5 ml-1">Full Name</label>
                        ...
                        <motion.div variants={itemVariants} className="pt-3">
                            ...
                            >
                                <div className="absolute inset-0 -translate-x-full group-hover:animate-[shimmer_1.5s_infinite] bg-linear-to-r from-transparent via-white/10 to-transparent skew-x-12"></div>
                                {loading ? (
                    ...
                    <motion.div variants={itemVariants} className="mt-7 flex items-center justify-between">
                        ...
                        <span className="text-[11px] text-center font-bold text-ocean-muted uppercase tracking-[0.15em]">or continue with</span>
                        <span className="border-b border-ocean-muted/20 w-1/4"></span>
                    </motion.div>
                    ...
                    <motion.p variants={itemVariants} className="mt-8 text-center text-ocean-muted font-medium text-sm">
                        Already have an account? <Link href="/auth/login" className="text-oceanic-blue font-bold hover:text-ocean-deep hover:underline transition-colors ml-1">Log in</Link>
                    </motion.p>
                </motion.div>
            </motion.div>
        </div>
