        ...
        <div className="bg-sky-light min-h-screen pt-24 pb-20">
            ...
            <div className="relative py-20 bg-sky-light overflow-hidden mb-12 border-b border-oceanic-blue/10">
                ...
                <div className="relative z-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                    ...
                    >
                        Uncompromising <span className="text-oceanic-blue italic">Quality</span>
                    </motion.h1>
                    <motion.p
                        initial={{ opacity: 0, y: 20 }}
                        animate={{ opacity: 1, y: 0 }}
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    {certifications.map((section, sectionIdx) => (
                        <div key={sectionIdx} className="relative">
                            ...
                            <div className="flex items-center gap-4 mb-10">
                                <h2 className="text-2xl font-heading font-black text-ocean-deep whitespace-nowrap">{section.category}</h2>
                                <div className="w-full h-px bg-oceanic-blue/15"></div>
                            </div>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                                {section.items.map((item, itemIdx) => (
                                    <motion.div
                                        ...
                                        className="flex flex-col sm:flex-row gap-6 bg-white/70 backdrop-blur-sm border border-oceanic-blue/10 p-8 rounded-xl hover:border-oceanic-blue/30 hover:shadow-lg transition-all duration-300"
                                    >
                                        <div className="shrink-0">
                                            <div className="w-20 h-20 rounded-full bg-oceanic-blue/5 border border-oceanic-blue/15 flex items-center justify-center">
                                                {item.icon}
                                            </div>
                                        </div>
                                        <div>
                                            <h3 className="text-xl font-heading font-bold text-ocean-deep mb-2">{item.name}</h3>
                                            <p className="text-ocean-muted text-sm leading-relaxed font-medium">{item.desc}</p>
                                        </div>
                                    </motion.div>
                                ))}
                            </div>
                ...
                <motion.div
                    ...
                    viewport={{ once: true }}
                    transition={{ duration: 0.8 }}
                    className="mt-24 p-10 bg-white/60 backdrop-blur-sm border border-oceanic-blue/10 rounded-xl text-center shadow-sm"
                >
                    <h3 className="text-2xl font-heading font-black text-ocean-deep mb-4">The Wave of Bengal Guarantee</h3>
                    <p className="text-ocean-muted max-w-2xl mx-auto leading-relaxed font-medium">
