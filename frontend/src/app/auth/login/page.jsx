    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-sky-light p-4">
            <div className="bg-white/80 backdrop-blur-md p-8 rounded-xl border border-oceanic-blue/20 w-full max-w-md shadow-lg">
                <h1 className="text-3xl font-heading font-black text-ocean-deep mb-6 text-center">Welcome Back</h1>
                ...
                <div className="mt-6 flex items-center justify-between">
                    ...
                    <span className="text-xs text-center font-bold text-ocean-muted uppercase tracking-wider">or login with</span>
                    <span className="border-b border-oceanic-blue/20 w-1/5 lg:w-1/4"></span>
                </div>
                ...
                <p className="mt-8 text-center text-ocean-muted font-medium text-sm">
                    New to Wave of Bengal? <Link href="/auth/register" className="text-oceanic-blue font-bold hover:text-ocean-deep hover:underline transition-colors">Create an account</Link>
                </p>
            </div>
        </div>
    );
