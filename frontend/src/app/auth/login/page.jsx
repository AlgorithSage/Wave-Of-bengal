    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-ocean-dark p-4">
            <div className="bg-ocean-teal p-8 rounded-xl border border-wob-gold/15 w-full max-w-md shadow-2xl">
                <h1 className="text-3xl font-heading text-text-light mb-6 text-center">Welcome Back</h1>
                ...
                <p className="mt-8 text-center text-text-muted text-sm">
                    New to Wave of Bengal? <Link href="/auth/register" className="text-gold hover:underline">Create an account</Link>
                </p>
            </div>
        </div>
    );
