...
export default function SustainabilityBanner() {
    return (
        <section className="relative overflow-hidden py-16 lg:py-24 bg-sky-light border-y border-wob-green/20">
            {/* Background Pattern */}
            <div className="absolute inset-0 z-0 opacity-10 bg-[url('https://www.transparenttextures.com/patterns/cubes.png')] mix-blend-multiply"></div>
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 w-full flex flex-col md:flex-row items-center justify-between gap-10">
                ...
                >
                    <div className="flex items-center gap-3 mb-4">
                        ...
                        <span className="text-wob-green uppercase tracking-widest text-sm font-bold">Our Commitment</span>
                    </div>
                    <h2 className="text-3xl md:text-5xl font-heading font-black text-ocean-deep mb-6">
                        Beyond the Catch
                    </h2>
                    <p className="text-lg text-ocean-deep/80 font-medium leading-relaxed max-w-2xl">
                ...
                >
                    <Link
                        href="/sustainability"
                        className="inline-flex items-center justify-center bg-transparent border-2 border-wob-green text-wob-green hover:bg-wob-green hover:text-sky-light font-bold py-4 px-8 rounded transition-all w-full sm:w-auto shadow-[0_4px_12px_rgba(5,150,105,0.15)] hover:-translate-y-1 hover:shadow-[0_6px_16px_rgba(5,150,105,0.25)]"
                    >
                        Learn Our Practices
                    </Link>
                </motion.div>
